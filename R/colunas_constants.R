...
.COLNAMES_COMPOSICAO_COMISSOES_CAMARA <- c("cargo"="character", "id"="integer", "partido"="character",
                                  "uf"="character", "situacao"="character", "nome"="character",
                                  "sigla"="character", "casa"="character")
